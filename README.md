...
**Hello Back End ROR** is a Rails back-end that serves as an API with an endpoint displaying a random message.
...
Click here to see the [front end repo](https://github.com/AsimKhan2019/Hello_Front_End_REACT/tree/setup-feature-api)
...
#### Github
- Enter this url: [https://github.com/AsimKhan2019/Hello_Back_End_ROR/tree/setup-api-rails](https://github.com/AsimKhan2019/Hello_Back_End_ROR/tree/setup-api-rails) in your web browser.
...
```sh
  git clone https://github.com/AsimKhan2019/Hello_Back_End_ROR.git
  cd Hello_Back_End_ROR
```
...
|------|--------|---------|----------|
|Waleed Amjad|[@githubhandle](https://github.com/AsimKhan2019/)|[@twitterhandle](https://twitter.com/vtechbiz)|[LinkedIn](https://www.linkedin.com/in/asim-khan-9bbb4211/)|
